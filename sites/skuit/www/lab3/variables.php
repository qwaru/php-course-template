...
<body>
    <div class="container">
        ...
        <p>Рост в дюймах: <span class="result"><?= round($heightlnches, 2) ?></span></p>
        <div class="hint">// рост в см / 2.54 = <?= round($heightlnches, 2) ?></div>
    ...
    <p>Информация: <span class="result"><?= $agelnfo ?></span></p>
